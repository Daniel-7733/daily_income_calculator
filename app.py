...
def main() -> None:
    ...
    # === Calculator Page ===
    Label(window, text="💰 Amount:", bg=background_color, fg=label_fg, font=("Segoe UI", 10)).pack()
    Entry(window, textvariable=amount_var, bg=entry_bg, fg=entry_fg, insertbackground=entry_fg).pack()

    Label(window, text="💱 Currency Symbol (e.g., USD, TRY):", bg=background_color, fg=label_fg, font=("Segoe UI", 10)).pack()
    Entry(window, textvariable=symbol_var, bg=entry_bg, fg=entry_fg, insertbackground=entry_fg).pack()

    Label(window, text="📈 Conversion Rate to TRY:", bg=background_color, fg=label_fg, font=("Segoe UI", 10)).pack()
    ...
    Label(window, text="🌙 Nights:", bg=background_color, fg=label_fg, font=("Segoe UI", 10)).pack()
